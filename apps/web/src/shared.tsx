...
export function Dog({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      viewBox="0 0 420 400"
      role="img"
      aria-label="雪纳瑞插画，等待上传啵啵的真实照片"
    >
      <ellipse cx="210" cy="357" rx="116" ry="16" fill="#637160" opacity=".2" />
      <path
        d="M132 335Q110 255 153 229L264 229Q305 256 290 339"
        fill="#737b76"
      />
      <path
        d="M143 242Q211 270 277 240L252 301L210 322L179 288Z"
        fill="#899a68"
      />
      <path
        d="M163 337L162 283M256 337L257 286"
        stroke="#414b46"
        strokeWidth="8"
        strokeLinecap="round"
      />
      <ellipse cx="151" cy="339" rx="31" ry="17" fill="#d9dbce" />
      <ellipse cx="269" cy="339" rx="31" ry="17" fill="#d9dbce" />
      <path
        d="M133 105Q72 47 82 144L118 207L147 173M278 105Q348 45 337 141L301 207L271 174"
        fill="#434e48"
        stroke="#424d47"
        strokeWidth="8"
      ...
      />
      <path
        d="M139 91Q207 53 276 94L298 167Q303 239 255 263L166 261Q113 238 122 165Z"
        fill="#818a7f"
      />
      <path
        d="M142 137L144 113L175 121L191 143L166 147Z M230 143L244 121L277 112L279 138L253 148Z"
        fill="#e7e8dc"
      />
      <ellipse cx="165" cy="159" rx="9" ry="12" fill="#283c32" />
      <ellipse cx="255" cy="159" rx="9" ry="12" fill="#283c32" />
      <circle cx="168" cy="155" r="3" fill="#fff" />
      <circle cx="258" cy="155" r="3" fill="#fff" />
      <path
        d="M156 187L118 203L142 215L131 232L163 236L170 262L190 253L210 277L229 253L250 265L256 238L285 231L275 215L301 203L267 186Q212 164 156 187"
        fill="#e4e5d7"
      />
      <path d="M190 191Q208 181 230 191L214 209L205 209Z" fill="#2e4035" />
      <path
        d="M210 208L210 225M192 230Q210 242 228 230"
        fill="none"
        stroke="#475449"
        strokeWidth="4"
        strokeLinecap="round"
      />
      <path
        d="M204 237Q211 233 219 237L217 248Q209 255 204 246Z"
        fill="#ce9180"
      />
      <path
        d="M156 208L185 214M149 221L180 225M238 214L267 208M242 225L274 221"
        stroke="#bcc1b4"
        strokeWidth="3"
        strokeLinecap="round"
      />
