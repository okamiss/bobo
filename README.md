...
5. 选择草稿或已发布，再选择公开或不公开，点击保存。发布时会自动记下当时的时分秒：同一天发好几篇时，前台和后台都按发布时间从新到旧排列，日期旁边显示具体时间。补录旧日期的记录（发生日期不是发布当天）只显示日期，不会安上发布当天的钟点。不公开的故事和相册（以及所有草稿）只有家庭账号能在后台看到，公开的已发布内容所有人都能看到。公开页面显示记录人的名字，即使由家庭管理员代为修改或发布也不会改变；里程碑和首页精选独立控制；勾选「首页精选」的故事会出现在首页「偏爱的这一页」，按日期从新到旧最多显示 3 篇；点右上角「全部看看」进入成长手账，可用「只看首页精选」筛选出全部精选，「只看值得纪念的里程碑」同理，两者可以叠加。
