...
5. 选择草稿或已发布，再选择公开或不公开，点击保存。不公开的故事和相册（以及所有草稿）只有家庭账号能在后台看到，公开的已发布内容所有人都能看到。公开页面显示记录人的名字，即使由家庭管理员代为修改或发布也不会改变；里程碑和首页精选独立控制；勾选「首页精选」的故事会出现在首页「偏爱的这一页」，按日期从新到旧最多显示 6 篇。
